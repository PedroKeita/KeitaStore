    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-[#111318] border border-white/5 rounded-3xl p-8">
        ...
        <p class="text-white/40 text-sm mb-8">
          Use sua conta Google para acessar seus pedidos, favoritos e muito mais.
        </p>
        ...
        <button
          ...
          class="w-full flex items-center justify-center gap-3 py-3.5 bg-white text-gray-800 font-semibold rounded-xl hover:bg-gray-100 active:scale-[0.97] transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
        >
          <!-- Ícone Google -->
